...
NSString * Movies$ModuleRequireFormat = @"(function(exports){"
...
-(void)didStartNewContext:(KrollContext*)kroll
{
    ...
    // Load the "Movies" object into the global scope
...
-(id)loadCommonJSModule:(NSString*)code withSourceURL:(NSURL *)sourceURL
{
	...
	NSString *js = [[NSString alloc] initWithFormat:Movies$ModuleRequireFormat, dirname, filename,code];
