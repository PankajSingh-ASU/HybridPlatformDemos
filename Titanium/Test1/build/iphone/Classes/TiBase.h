...
// in simulator we redefine to format for Test1 Developer console
...
{\
	NSString * exceptionName = [@"org.test1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.test1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITest1NativeItemNone = -1, 
	UITest1NativeItemSpinner = -2,
	UITest1NativeItemProgressBar = -3,
	
	UITest1NativeItemSlider = -4,
	UITest1NativeItemSwitch = -5,
	UITest1NativeItemMultiButton = -6,
	UITest1NativeItemSegmented = -7,
	
	UITest1NativeItemTextView = -8,
	UITest1NativeItemTextField = -9,
	UITest1NativeItemSearchBar = -10,
	
	UITest1NativeItemPicker = -11,
	UITest1NativeItemDatePicker = -12,
	
	UITest1NativeItemInfoLight = -13,
	UITest1NativeItemInfoDark = -14,
	
	UITest1NativeItemDisclosure = -15,
	
	UITest1NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Test1 instances of
