...
/**
 The base class for all Test1 modules
 */
...
/**
 Test1 Platform calls this method on startup.
 */
-(void)startup;

/**
 Test1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Test1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Test1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Test1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
